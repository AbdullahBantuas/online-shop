...
//
import TourList from '../like-list';
import TourSort from '../like-sort';
import TourSearch from '../like-search';
import TourFilters from '../like-filters';
import TourFiltersResult from '../like-filters-result';
